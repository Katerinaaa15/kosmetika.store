    ...
    <form method="POST" enctype="multipart/form-data"
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                ...
                <input id="code" type="text" name="code" class="form-control" value="{{ old('code', $product->code ?? '') }}" required>
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                ...
                <input id="price" type="number" step="0.01" name="price" class="form-control" value="{{ old('price', $product->price ?? '') }}" required>
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                ...
                <input id="count" type="number" step="0.01" name="count" class="form-control" value="{{ old('count', $product->count ?? '') }}" required>
            </div>
        </div>
        ...
        <div class="mb-4 row align-items-center">
            <label for="image" class="col-sm-2 col-form-label">Attēls:</label>
            <div class="col-sm-10">
                ...
                @if(isset($product) && $product->image)
                    <div class="mt-2">
                        <img src="{{ Storage::url($product->image) }}" alt="Esošais attēls" width="120">
                    </div>
                @endif
            </div>
        </div>
